...
AI Trainer Community is a local-first FastAPI application.
...
Community Edition disables collaborative and private deployment features by default, including chat, presence, class administration, feedback administration, WeChat gating, operation unlock gates, and bundled AI grading.
