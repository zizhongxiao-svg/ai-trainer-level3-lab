export function renderArchitecture(host) {
  host.innerHTML = `
    <section class="bk-card">
      <h2 style="margin-top:0">Community Architecture</h2>
      <p class="small">AI Trainer Community runs as a local FastAPI app with SQLite persistence and static Vue pages.</p>
